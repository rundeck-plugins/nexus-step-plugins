...
# Register this VM to the project's resource model.
...
do
	...
	cp /vagrant/rundeck/id_rsa.pub $CATALINA_BASE/.ssh/authorized_keys2
	...
	cp /vagrant/jenkins/simple-1.0.0.war $CATALINA_BASE/webapps-1.0.0/simple.war
...
cp /vagrant/rundeck/id_rsa.pub /home/rundeck/.ssh/authorized_keys2
